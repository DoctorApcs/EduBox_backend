...
class ResearchAgent:
    ...
    async def run_initial_research(self, research_state: dict):
        ...
        initial_research, _ = await self.research(query=query, verbose=task.get("verbose"),
